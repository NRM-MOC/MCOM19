...
```{r, echo = FALSE, fig.cap=paste("Geometric mean for", conc, "{{var_name}}, 2016-2018."), eval={{maps}}}
...
```{r, echo = FALSE, fig.cap=paste("Fitted trend for", conc, "{{var_name}}, 2009-2018."), eval={{maps}}}
